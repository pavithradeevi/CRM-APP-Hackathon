...
const renderActiveShape = (Pavithra) => {
    ...
    return (
        <g>
            <text x={cx} y={cy} dy={8} textAnchor="middle" fill={"green"} style={{fontSize:14}}>
                {payload.name}
            </text>
            <Sector
                cx={cx}
              ...
              <div>
                        <div style={{ display: 'flex', marginLeft: "50px", marginTop: 13 }}>
                                  <div className='introContainer'>
                                            <div style={{ width: '30%' }}>
                                                      <p style={{ textAlign: 'start', color: "white", marginLeft: 15 }}>Hey Pavithra</p>
